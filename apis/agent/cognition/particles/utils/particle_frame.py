"""
Particle-based Cognition Engine - the underlying foundation of all particles - every particle type inherits and builds off this class; this "BaseParticle" class does not spawn as it's own distinct particle in the field.
